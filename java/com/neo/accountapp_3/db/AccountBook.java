...
public class AccountBook extends SharedModel implements Serializable {
   // ArrayList<ArrayList<String>> AccountList = new ArrayList<ArrayList<String>>();
    ...
    public AccountBook(Context mContext) {
        this.oContext = mContext; //부모클래스에 전달

        dbname = "AccountBook"; //db name 지정

        //커플고유키, 날짜, 가격, 인물 카테고리 키, 내역, 사용카테고리 키, 결재 카테고리 키, 등록 시간
        Field = new String[]{
                "couplekey", "date", "price", " who", "explain", "usecategorykey", "paymentcategorykey", "regtime", "placename", "place_x", "place_y"
               // "couplekey", "date", "price", " who", "explain", "usecategorykey", "paymentcategorykey"
        };
    }
    ...
    public String SaveAccountobject(String Couplekey, int selectyear, int selectmonth, int selectday, String selectdayofweek, int price, String who, String explain, String usecategorykey, String paymentcategorykey, String placename, String place_x, String place_y){
